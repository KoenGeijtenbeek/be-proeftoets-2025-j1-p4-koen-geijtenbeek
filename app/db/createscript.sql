...
VALUES
 ...
 ('Audemars Piguet', 'Royal Oak Selfwinding Chronograph', 43000, 1, NULL, SYSDATE(6), SYSDATE(6)),
 ('Patek Philippe', 'Nautilus 5712/1A', 71000, 1, NULL, SYSDATE(6), SYSDATE(6));
